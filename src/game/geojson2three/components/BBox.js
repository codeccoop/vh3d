...
BBox.prototype.get = function () {
  ...
  dist.center = [
    dist.lngs[0] + (dist.lngs[1] - dist.lngs[0]) / 2,
    dist.lats[0] + (dist.lats[1] - dist.lats[0]) / 2,
  ];
...
BBox.prototype.updateZ = function (feat, zField) {
  ...
  this._bbox.Z[0] =
    this._bbox.Z[0] == null
      ? feat.properties[zField]
      : Number(this._bbox.Z[0]) < Number(feat.properties[zField])
      ? Number(this._bbox.Z[0])
      : Number(feat.properties[zField]);
  this._bbox.Z[1] =
    this._bbox.Z[1] == null
      ? props[zField]
      : Number(this._bbox.Z[1]) > Number(feat.properties[zField])
