class Camera extends THREE.PerspectiveCamera {
  ...
  centerOn(layer) {
    ...
    const x = (layer.xScale(bbox.center[0] + layer.xScale._range / 2) - layer.xScale(bbox.center[0] - layer.xScale._range / 2)) / 2;
    const y = (layer.yScale(bbox.center[1] + layer.yScale._range / 2) - layer.yScale(bbox.center[1] - layer.yScale._range / 2)) / 2;
